...
개발에 첫 발을 내딛은지 3년이 지난 웹 개발자입니다.<br>

꼭 두가지를 목표로 업무에 임하고 있습니다. 첫번째는 간결하고 명쾌한 코드를 짜기 위해 노력합니다. 이 노력은 보다 주의 깊게 코드를 짜는 습관을 만들어 주었습니다.

두번째, 커뮤니케이션 능력은 때로 코딩 실력보다 우선시되어야 한다고 생각합니다. 이를 위해 공부한 내용과 생각을 정리,기록하고 있습니다.
